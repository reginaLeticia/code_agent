...
from codeagent.chat_env import ChatEnv
...
class ComposedPhase(ABC):
    def __init__(self,
        ...
        for phase in self.config_phase:
            ...
            phase_module = importlib.import_module("codeagent.phase")
...
class FormatAnalysis(ComposedPhase):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
...
class SecurityTest(ComposedPhase):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
